...
@configclass
class PackingInstanceRandomizeEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the packing environment."""

    # Scene settings
    scene: PackingTableSceneCfg = PackingTableSceneCfg(num_envs=4096, env_spacing=2.5, replicate_physics=False)
    # Basic settings
