...
class FrankaBinStackEnvCfg(StackEnvCfg):
    def __post_init__(self):
        ...
        self.scene.blue_sorting_bin = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.5, 0.4), rot=(1.0, 0.0, 0.0, 0.0)),
            spawn=UsdFileCfg(
        ...
        # The bin is at (0.0, -0.5, 0.4), so cube_1 should be slightly above it
        self.scene.cube_1 = RigidObjectCfg(
            prim_path="{ENV_REGEX_NS}/Cube_1",
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.5, 0.405), rot=(1.0, 0.0, 0.0, 0.0)),
            spawn=UsdFileCfg(
