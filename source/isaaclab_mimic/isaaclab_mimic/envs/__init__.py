...
##
# Franka Packing: IK Relative Pose Control
##

gym.register(
    id="Isaac-Pack-Object-Franka-IK-Rel-Mimic-v0",
    entry_point=f"{__name__}.franka_pack_ik_rel_mimic_env:FrankaPackIKRelMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.franka_pack_ik_rel_mimic_env_cfg:FrankaPackIKRelMimicEnvCfg",
    },
    disable_env_checker=True,
)
